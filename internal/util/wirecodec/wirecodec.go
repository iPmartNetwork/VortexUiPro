...
// transport: zstd (de)compression and SHA-256 integrity hashing.
package wirecodec
...
const (
	...
	EncodingZstd = "zstd"
	// CapZstd is the capability token advertised in headers.
	CapZstd = "zstd"

	// maxDecodeBytes bounds in-memory decompression.
...
// Decompress zstd-decompresses src, rejecting output larger than maxOut.
